...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Created Accounts')); ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($user->image_path && file_exists(public_path($user->image_path))): ?>
                                    <img src="<?php echo e(asset($user->image_path)); ?>" alt="User Image" class="h-10 w-10 rounded-full">
                                <?php else: ?>
                                    <span>No Image</span>
                                <?php endif; ?>
                            </td>
...
<?php endif; ?>
<?php /**PATH /Users/rafaelfernandez/Pictures/Athlete gym portal/resources/views/created-accounts.blade.php ENDPATH**/ ?>